defmodule Plaid.InstitutionsTest do
  ...
  test "/institutions/get without options", %{bypass: bypass, api_host: api_host} do
    Bypass.expect_once(bypass, "POST", "/institutions/get", fn conn ->
      Conn.resp(conn, 200, ~s<{
        "institutions": [
          {
  ...
  test "/institutions/get_by_id without options", %{bypass: bypass, api_host: api_host} do
    Bypass.expect_once(bypass, "POST", "/institutions/get_by_id", fn conn ->
      Conn.resp(conn, 200, ~s<{
        "institution": {
          "country_codes": [
  ...
  test "/institutions/search without options", %{bypass: bypass, api_host: api_host} do
    Bypass.expect_once(bypass, "POST", "/institutions/search", fn conn ->
      Conn.resp(conn, 200, ~s<{
        "institutions": [
          {
