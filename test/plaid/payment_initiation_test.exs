defmodule Plaid.PaymentInitiationTest do
  ...
  test "/payment_initiation/recipient/create without options", %{
    bypass: bypass,
    api_host: api_host
  } do
    Bypass.expect_once(bypass, "POST", "/payment_initiation/recipient/create", fn conn ->
  ...
  test "/payment_initiation/payment/create without options", %{
    bypass: bypass,
    api_host: api_host
  } do
    Bypass.expect_once(bypass, "POST", "/payment_initiation/payment/create", fn conn ->
  ...
  test "/payment_initiation/payment/list without options", %{bypass: bypass, api_host: api_host} do
    Bypass.expect_once(bypass, "POST", "/payment_initiation/payment/list", fn conn ->
      Conn.resp(conn, 200, ~s<{
        "payments": [
          {
